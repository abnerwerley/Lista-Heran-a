...
public class Principal {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.println("1 - Cachorro"); System.out.println("2 - Cavalo");
		 * System.out.println("3 - Preguiça"); opcao = entrada.nextInt();
		 * 
		 * if (opcao == 1) { cachorrinho.definindoCachorro(); } else if (opcao == 2) {
		 * cavalinho.definindoCavalo(); } else if (opcao == 3) {
