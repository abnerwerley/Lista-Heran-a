...
public class Cachorro extends Animal {
	...
	public void definindoCachorro() {
		...
		System.out.println("O " + cachorro1.getNome() + " vive até " + cachorro1.getIdade() + " e o som que faz é o "
				+ cachorro1.getSom() + " e sua alimentação é " + cachorro1.getAlimentacao() + " e ele "
				+ cachorro1.getCorrer() + ".");
