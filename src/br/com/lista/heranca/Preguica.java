...
public class Preguica extends Animal {
	...
	public void definindoPreguica() {
		...
		System.out.println("A " + preguica1.getNome() + " vive em média " + preguica1.getIdade()
				+ " em seu habitat natural. Tem a alimentação " + preguica1.getAlimentacao()
				+ " e faz um som bem peculiar " + preguica1.getSom() + " e sua ação é a de " + preguica1.getAcao()
				+ " e a curiosidade é que ela " + preguica1.getCuriosidade());
